...
var basil = new SweetSweetBasil("Worlds", "red");
basil.getColor();
...
var basil2 = new Basil("newBasilName", "colorful");
basil2.getColor();
basil2.setNewColor("Orange");
basil2.getColor();
var getcoffee_1 = __webpack_require__(0);
var ReallyCoffee = (function (_super) {
    __extends(ReallyCoffee, _super);
    function ReallyCoffee() {
        return _super.call(this) || this;
    }
    ReallyCoffee.prototype.show = function (input) {
        var a = 100;
        if (input) {
            var b = 1010;
            return b;
    ...
    ReallyCoffee.prototype.setBackgroundColor = function () {
